...
public class ProgrammingMCQAnswerResponse {
    ...
    private List<ProgrammingMCQAttemptResponse> attemptHistory;
    private PracticeRecommendationResponse nextQuestion;

    public ProgrammingMCQAnswerResponse(
            Long questionId,
            Boolean isCorrect,
            ...
            List<ProgrammingMCQAttemptResponse> attemptHistory,
    ...
    public List<ProgrammingMCQAttemptResponse> getAttemptHistory() {
